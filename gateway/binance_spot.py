...
class OrderStatus(Enum): # 訂單狀態:新訂單、部分完成、已完成、取消、待取消、訂單被拒絕、訂單過期
    NEW = 'NEW'
...
class BinanceSpotHttp(object):
    ...
    def get_order_book(self, symbol, limit=5):
        """
        :param symbol: BTCUSDT, BNBUSDT ect, 交易對
        :param limit: market depth.
        :return: return order_book in json 回傳json格式的訂單簿
        """
    ...
    def _sign(self, params):
        """
        簽名的方法， signature for the private request.
    ...
    def place_order(self, symbol: str, order_side: OrderSide, order_type: OrderType, quantity: float, price: float,
        ...
        """
        :param symbol: 交易對
        :param order_side: 買/賣， BUY or SELL
        :param order_type: 訂單類型 LIMIT or other order type.
        :param quantity: 數量
        :param price: 價格
        :param client_order_id: 使用者的訂單ID
        :param time_inforce:
        :param stop_price:
        :return:
        """
